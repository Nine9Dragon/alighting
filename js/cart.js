...
axios.get("http://127.0.0.1:3000/product/searchCart").then(result=>{
    ...
    if(result.data.code == 0){
        ...
        if(result.data.data.length>0){
            ...
            <div class="cart_cnt clearfix">
                ...
                <div class="cart_submit_box clearfix" style="padding-left: 700px" att="${key.cid}">
                    <div class="cart_submit_box_pre" >
                        ...
                        <p>
                            <label>产品总价 :</label>
                            <span id="price">${key.price.toFixed(2)}</span>元
                        </p>
                        <p class="mTop10">
                            <label>支付总金额 :</label>
                            <b class="cf60 f16" id="price" price="${key.price}">${key.price.toFixed(2)}</b>
            ...
            var aaa = document.querySelector(".icon_del");
            ...
            var td = document.querySelector(".cart_cnt");
            td.addEventListener("click",function(e){
                ...
                if(e.target.nodeName=="I"){
                    ...
                    if(e.target.innerHTML=="-"&&parseInt(inp.value)>1){
                    ...
                    var count = b[0];
                    var sum = b[1];
                    count.innerHTML = inp.value;
                    sum.innerHTML = (inp.value*sum.getAttribute("price")).toFixed(2)
